...
The variables are have missing values.
...
From the given data it can be concluded that level of RSPM and PM2.5 are extremely higher in all cities of India. Furthermore, Uttarachai have the highest SO2 concentration in the air. West Bengal have the highest NO2 concentration in the air. Delhi have the highest RSPM index and SPM index. The major cause of generation of pollutants was similar across the states of India which was industrial area. By carrying out exploratory data analysis, creating time series regression model and clustering technique able to visualize the condition of air quality in India deeply in different circumstances. Furthermore, the collected data can be utilized to model various pollutant behavior scenarios in the context of changing air quality policies or pollution generating patterns. Hence, the government of India should implement more efforts to make air quality monitoring a national priority by raising awareness and enforcing key laws and regulations to reduce pollution levels in the air.
